...
// =========================================================================
{
  ...
  check('api/showcase-media.js resolves the puppy via resolveVisiblePuppyByRef() (covers hide + tenant/litter-chain drift) on every request', /resolveVisiblePuppyByRef\(db, showcase, litterId, puppyRef\)/.test(mediaSrc))
