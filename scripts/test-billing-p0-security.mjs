...
check(
  'exactly the two Plus price ids are allowlisted — no launch-offer price, no legacy tiers',
...
check(
  'production Firebase resolves only verified iDogs live A$7/A$70 Plus prices',
  CHECKOUT_PRICE_IDS.plus_monthly === 'price_1UAInbGHgBd6ZgJE0NAikQgm' &&
    CHECKOUT_PRICE_IDS.plus_annual === 'price_1UAIngGHgBd6ZgJEh3njs6hZ'
)
