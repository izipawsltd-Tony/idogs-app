...
// =========================================================================
{
  ...
  const checkoutSrc = readFileSync(new URL('../api/_lib/checkout-handler.js', import.meta.url), 'utf8')
  // iDogs Pricing v1.1 (Pricing_Decision_Record_v1.1.md, LOCKED)
  // deliberately retired the legacy Basic/Pro/Kennel/SMS-addon four-tier
...
// =========================================================================
{
  ...
  for (const [file, op, code] of [
    ...
    ['_lib/checkout-handler.js', 'create-checkout', 'APP_URL_NOT_CONFIGURED'],
