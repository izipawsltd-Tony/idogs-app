  ...
  if (notFound) {
    return (
      <div style={{ maxWidth: 500, margin: '60px auto', padding: 32, background: '#ffffff', border: '1px solid #dfe5df', borderRadius: 12, textAlign: 'center', boxShadow: '0 2px 8px rgba(16,41,29,0.06)' }}>
        ...
        <h3 style={{ fontSize: 20, color: '#1a3a2a', marginBottom: 8, fontWeight: 700 }}>User Not Found</h3>
        <p style={{ color: '#53635a', fontSize: 14, lineHeight: 1.6, marginBottom: 20 }}>
          This account does not exist on this platform.
        </p>
        <Link to="/app/super-admin/users" className="btn btn-secondary btn-sm" style={{ textDecoration: 'none' }}>
          Back to Users
        </Link>
      </div>
    )
