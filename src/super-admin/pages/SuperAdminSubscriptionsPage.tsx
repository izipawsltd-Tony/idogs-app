    ...
    <div className="super-admin-page">
      ...
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <div className="super-admin-module-card">
          ...
          <h3 style={{ fontSize: 26, margin: '6px 0 0', fontWeight: 700, color: '#c8971f' }}>{summary?.plusAccounts ?? 0}</h3>
        </div>
        <div className="super-admin-module-card">
        ...
        <div className="super-admin-module-card">
          <span>INTERNAL ENTITLEMENTS</span>
          <h3 style={{ fontSize: 26, margin: '6px 0 0', fontWeight: 700, color: '#1a3a2a' }}>{summary?.internalEntitlementAccounts ?? 0}</h3>
        </div>
        <div className="super-admin-module-card">
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #dfe5df', textAlign: 'left', color: '#6c7a70' }}>
                  ...
                  <th style={{ padding: '10px 8px', fontWeight: 600 }}>Billing Interval</th>
                  <th style={{ padding: '10px 8px', fontWeight: 600, textAlign: 'center' }}>Internal Grant</th>
                    ...
                    <tr key={s.uid} style={{ borderBottom: '1px solid #f4f6f5' }}>
                      ...
                      <td style={{ padding: '10px 8px' }}>
                        <span style={{
                          ...
                          background: s.plan === 'free' ? '#e2e8f0' : '#e1f5ee',
                          color: s.plan === 'free' ? '#475569' : '#085041',
                          textTransform: 'uppercase',
                        }}>
                          {s.plan}
                        </span>
                      ...
                      <td style={{ padding: '10px 8px', textAlign: 'center' }}>{s.internalEntitlement ? '✓' : '—'}</td>
