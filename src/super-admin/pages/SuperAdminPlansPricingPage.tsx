    ...
    <div className="super-admin-page">
      ...
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <div className="super-admin-module-card">
          ...
          <h3 style={{ fontSize: 26, margin: '6px 0 0', fontWeight: 700, color: '#1a3a2a' }}>{summary?.activePaidAccounts ?? 0}</h3>
        </div>
        <div className="super-admin-module-card">
          <span>INTERNAL ENTITLEMENTS</span>
          <h3 style={{ fontSize: 26, margin: '6px 0 0', fontWeight: 700, color: '#085041' }}>{summary?.internalEntitlementAccounts ?? 0}</h3>
        </div>
      </section>
