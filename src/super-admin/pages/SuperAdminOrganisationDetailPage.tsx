    ...
    <div className="super-admin-page">
      ...
      <div className="super-admin-panel" style={{ background: '#fbfcfc', border: '1px solid #dfe5df', padding: 16, marginBottom: 24, borderRadius: 8 }}>
        ...
        <p style={{ margin: 0, fontSize: 12, color: '#6c7a70', lineHeight: 1.5 }}>
          This console provides a <strong>read-only</strong> view of tenant registries. Profile edits, custom configuration writes, subscription modifications, and account suspensions are completely disabled in iDogs V1. Metrics come from server-side read-only queries.
        </p>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {user ? (
            <SuperAdminAccountOperations
              ...
              onUpdated={fetchOrganisationDetail}
            />
          ) : null}
