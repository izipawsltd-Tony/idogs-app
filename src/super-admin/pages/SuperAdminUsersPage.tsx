  ...
  return (
    <div className="super-admin-page">
      ...
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <div className="super-admin-module-card">
          <span>FREE PLAN</span>
          <h3 style={{ fontSize: 28, margin: '6px 0 0', fontWeight: 700, color: '#c8971f' }}>{freeUsers}</h3>
        </div>
        <div className="super-admin-module-card">
          <span>PLUS ENTITLED</span>
          <h3 style={{ fontSize: 28, margin: '6px 0 0', fontWeight: 700, color: '#085041' }}>{plusUsers}</h3>
        </div>
      </section>
                  ...
                  <tr key={u.uid} style={{ borderBottom: '1px solid #f4f6f5' }}>
                    ...
                    <td style={{ padding: '10px 8px' }}>
                      <span style={{
                        ...
                        padding: '2px 6px',
                        borderRadius: 4,
                        background: u.plan === 'free' ? '#e2e8f0' : '#e1f5ee',
                        color: u.plan === 'free' ? '#475569' : '#085041',
                        textTransform: 'uppercase'
                      }}>
                        {u.plan}
                      </span>
